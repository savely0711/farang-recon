...
Вкладки таблицы (их делает и наполняет скрипт-приёмник):
  ...
  «Счётчик»    — строка = ник. Сколько объявлений за 7 дней, за 30 дней и за
                 всё время, первый и последний пост, в каких группах, доля
                 от всех объявлений. Пересчитывается сама раз в сутки и
                 кнопкой в меню таблицы.
