...
_SYSTEM = (
    ...
    "УСЛУГА→services (уборка, ремонт, сантехник, трансфер, доставка, маникюр, "
    "массаж, репетитор, фотограф, визы и документы, экскурсии, груминг, ремонт "
    "техники и т.п. — всё, где продают работу, а не вещь). Если объявление, но "
